<%-- 
    Document   : AddEquipo
    Created on : 17/05/2017, 11:57:06 AM
    Author     : Juan Vanzina
--%>
...
<div id="sbi_container" class="sbi_container" style="height: 225px;">
    ...
    <form action="CreaEquipo" method="post" id="form1" >
    <p>&nbsp;</p>
    ...
    <table> 
        ...
        <td colspan="2">
        Serial del Equipo:
        <input name="serial" type="text" id="serial" pattern="[A-Za-z0-9]+" required/>
        </td>
        </tr><tr>
        <td>
        Placa Inventario:
        <input name="placa" type="number" id="serial" required/>
        </td>
         <td>
        Orden de Compra:
        <input name="OrdenComp" type="text" id="serial" required/>
        </td>
        </tr>
        <tr>
        <td>
        Fecha de Compra:
        <input name="fcomp" type="date" id="fcomp" required/>
        </td><td>
        Meses de Garantia:
        <input name="mgarant" type="number" id="serial" required/>
        </td>
        </tr>
        <tr>
        <td>
        Punto de Red:
        <input name="puntored" type="text" id="serial" required/>
        </td><td>
        Host / Dominio / # Extensión:
        <input name="dominio" type="text" id="serial" required/>
        </td>
        </tr>
        <tr>
        <td colspan="2">
        Mac Address:
        <input name="mac" type="text" id="serial" required/>
        </td>
        </tr>
        <tr>
        <td colspan="2">
        Mac Address 2:
        <input name="mac2" type="text" id="serial"/>
        </td>
        </tr>
        <tr>
            <td colspan="2">
                 ...
                 <div class="select">
                                                            <select name="tipoeq" class="textocom" id="sports" required>
                                                                        ...
                                                                        <option value="11">Sistema Inalámbrico - kramer</option>
        ...
        <tr>
            <td>
                ...
                <select name="marca" class="textocom" id="player" required>
                              <option value="">
                              Seleccione primero Tipo</option>                      
                            </select>  
                </div>
            </td>
            <td>
                ...
                <div class="select">
                    <select name="modelo" class="textocom" id="equipo" required>
                        <option value="">
                        Seleccione primero Tipo y Marca</option>                      
                    </select>  
                </div>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <br>
                Ubicación:
                <input name="ubicacion" type="text" id="serial" required/>
            </td>
        </tr>
        <tr>
            <td colspan="2">
            Observaciones: <br>
            <input name="observa" type="text" id="serial"/>
            </td>
        </tr>
    </table>    
        ...
        <button name="B1" type="submit" class="boton" value="Crear Servicio" >Crear Nuevo Equipo</button>
            </font></strong></div>
      </fieldset>
    </form>  
