...
<script language="JavaScript" type="text/JavaScript">
    ...
    function cargar()
    {
        ...
        {
            document.form1.action='Consulta_Asign';  
...
String id_asig="0";
 ...
 id_asig = (String) request.getParameter("id_asig");
  
 Vector estado = new Vector();
 
if(est == null && id_asig !=null){
   estado = bd.Solicitud_porSolic(rol,"0",nombre,id_asig) ;
}
else if(est != null && id_asig == "0"){   
    estado = bd.Solicitud_porSolic(rol,est,nombre,"0") ;
}
else if(est != null && id_asig != null){ 
    estado = bd.Solicitud_porSolic(rol,est,nombre,id_asig) ;
}
%>
<html lang="es">
    <head>
                                        ...
                                        <table width="100%" border="4">
                                            <tr>
                                                <td bgcolor="#FFFFFF" width="28%" height="33" > 
                                                    <div align="right"><font face="sans-serif" size="2" color="#000099"><b><font size="2">Seleccione Estado de Solicitud: &nbsp;&nbsp;</font></b></font></div>
                                                </td>
                                                <td>
                                                            <select name="Estado" >
                                                                            ...
                                                                            <option value="4">Pendiente Reasignar</option>}
                                                            </select>                                                    
                                                </td>
                                                <td bgcolor="#FFFFFF" width="28%" height="33" > 
                                                    <div align="right"><font face="sans-serif" size="2" color="#000099"><b><font size="2">&oacute; Ingrese N&uacute;mero de Solicitud: &nbsp;&nbsp;</font></b></font></div>
                                                </td>
                                                <td>
                                                    <input type="text" name="id_asig" value="0">
                                                </td>
                                                <td>
              ...
              <tr> 
                <td bgcolor="#FFFFFF" colspan="2" height="33" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    <tr> 
                        <td align="center" bgcolor="#6699CC" colspan="11"><b><font face="sans-serif" size="3" color="#FFFFFF" >SOLICITUDES: <%=estado.size()%></font></b></td>
                    </tr>
                    <tr align="center"> 
                      ...
                      <td width="12%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Solicitud</b></font></td>
                      <td width="18%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Soluci&oacute;n</b></font></td>
                      <td width="37%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado Solicitud </b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Bloque</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Area Solicitante</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tipo Solicitud</b></font></td>                   
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Extensi&oacute;n Solicitante</b></font></td>                   
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Usuario Crea Tarea</b></font></td>                   
                    ...
                    <tr bgcolor="#CCCCCC"> 
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(0)%></b></font></div>
                      </td>
                     <td width="5%" height="48" > 
