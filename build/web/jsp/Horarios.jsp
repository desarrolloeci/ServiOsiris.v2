...
<script language="JavaScript" type="text/JavaScript">
    ...
    function cargar()
    {
        ...
        {
            document.form1.action='Tramitar';  
              ...
              <tr> 
                <td bgcolor="#FFFFFF" colspan="2" height="33" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    <tr> 
                        <td align="center" bgcolor="#6699CC" colspan="18"><b><font face="sans-serif" size="3" color="#FFFFFF" >HORARIOS PERSONAL OSIRIS. #Personas: <%=estado.size()%></font></b></td>
                    </tr>
                    <tr> 
                      <td width="30%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Nombre </b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Ubicación</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Estado</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Tiempo Prom. Solucion</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Servicios Solucionados</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Servicios Cancelados</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Servicios Suspendidos</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Servicios que Reasigna</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Pendiente Reasignar</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Pendiente/En Proceso</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Total</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Calificación</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Tipo Horario</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Hora Inicio L-V</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Hora Fin L-V</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Hora Inicio Sabado</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="25" align="center"><font face="sans-serif" size="2" color="#000099"><b>Hora Fin Sabado</b></font></td>                   
                      <%if(rol.equals("8")){%>
                      <td width="5%" bgcolor="#99CCFF" height="25"> 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><b>Editar</b></font></div>
                      </td>
                      <%}%>
                    </tr>
                    <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td colspan="9" bgcolor="#99CCFF"><center>Resultados del ult. mes.</center></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                     ...
                     <td width="5%" height="48" > 
                      ...
                      <%if(Integer.parseInt(res.elementAt(9).toString()) > 3000){%>
                      <td width="5%" height="48" > 
                          <div align="center"><font face="sans-serif" size="2" color="#C20606"><p style="color:#FF0000";><%=res.elementAt(9)%> Min</p></font></div>
                      </td>
                      <%}else{%>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(9)%> Min</font></div>
                      </td>
                      <%}%>
                      <%if(rol.equals("8")){%>
                      <td width="5%" height="48" > 
                      ...
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(11)%></font></div>
                      </td>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(12)%></font></div>
                      </td>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(13)%></font></div>
                      </td>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(14)%></font></div>
                      </td>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><%=res.elementAt(15)%></font></div>
                      </td>
                      <td width="5%" height="48" > 
                      ...
                      <%}else{%>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"> -- </font></div>
                      </td>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"> -- </font></div>
                      </td>
                      ...
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"> <%=res.elementAt(17)%> </font></div>
                      </td>
                      <%}%>
                      <td width="5%" height="48" > 
                      ...
                      <%if(rol.equals("8")){%>
                      <td width="5%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><a href="Editar_Horario?usr=<%=res.elementAt(8)%>"><img src="img/horario.png" width="20" height="22" border="0"></a></font></div>
                      </td>
                      <%}%>
                    </tr>
                    <%}%>
