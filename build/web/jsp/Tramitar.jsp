...
String solic = "";
    ...
    estado = bd.EstSolicitud_Tram(rol,usu) ;
    ...
    <center>
               ...
               <tr> 
                <td bgcolor="#FFFFFF" width="28%" height="33" > 
                  <div align="left"><font face="sans-serif" size="2" color="#000099"><b><font size="3"> A continuación se presentan sus tareas en PROCESO: &nbsp;&nbsp;</font></b></font></div>
                </td>
               </tr>
              <tr> 
              ...
              <tr> 
                <td bgcolor="#FFFFFF" colspan="2" height="33" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    <tr> 
                        <td align="center" bgcolor="#6699CC" colspan="9"><b><font face="sans-serif" size="3" color="#FFFFFF" >SOLICITUDES EN PROCESO: <%=estado.size()%></font></b></td>
                    </tr>
                    <tr  align="center"> 
                      ...
                      <td width="18%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado</b></font></td>
                      <td width="12%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Solicitud</b></font></td>
                      <td width="37%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Responsable </b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Bloque</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado Asignacion</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Asignacion</b></font></td>                   
                      <td width="7%" bgcolor="#99CCFF" height="15"> 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><b>Tramitar</b></font></div>
                      </td>
                    </tr>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                     ...
                     <td width="5%" height="48" > 
                      ...
                      <td width="7%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><a href="Detalle?idd=<%=res.elementAt(0)%>"><img src="img/ini_proc.png" width="40" height="42" border="0"></a></font></div>
                      </td>
                    </tr>
                    <%}%>
                    <tr bgcolor="#99CCFF"> 
                  ...
                  <%}else if(c!=9){%>
                  <br><center><strong>No tiene tareas en Proceso <%=solic%></strong></center>
                  <%}%>
                </td>
              </tr>
