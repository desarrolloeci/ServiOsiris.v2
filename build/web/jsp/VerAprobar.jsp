...
"https://www.w3.org/TR/html4/loose.dtd">
  ...
  Vector equipospend  = new Vector();
  
   equipospend = bd.EquiposAprob();
...
<div class="content">               
<div id="sbi_container" class="sbi_container" style="height: 215px">
          ...
          <form><input class="boton_personalizado2" type="button" value="< Regresar" name="volver atrás2" onclick="history.back()" /></form>
            <div class="login-block" style="margin-top: -62px;">
                <br> <br>
                <br> <br>
                <br> <br>
...
<center>
    ...
    <%if( usr.equals("juan.vanzina") || usr.equals("carlos.acevedo")){%>
                                <div align="center" style="width: 900px;">
                                 
                                    
                                    <table class="table" width="100%" border="1" align="top">
                                    <tr>
                                        <td bgcolor="#99CCFF" width="20%" height="33" align="center"><strong>Serial</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Placa Inventario</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Marca</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Modelo</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Fecha Compra</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Fecha Creación</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Responsable</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Estado</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Salon</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Aprobar</strong></td>
                                        <td bgcolor="#99CCFF" width="10%" height="33" align="center"><strong>Ver Detalle</strong></td>
                                    </tr>
                                    <tr><td></td></tr>
                                    <%for(int i = 0; i < equipospend.size(); i++){
                                            Vector aux2 = (Vector)equipospend.elementAt(i);
                                    %>
                                    <tr bgcolor="#CCCCCC" height="33">
                                        <td width="20%" width="15" align="center"><%=aux2.elementAt(0)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(1)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(2)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(3)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(4)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(5)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(6)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(7)%></td>
                                        <td width="10%" width="15" align="center"><%=aux2.elementAt(8)%></td>
                                        <td width="5%" width="15" align="center">
                                            <form action="AprobarEquipo" method="POST" id="my_form<%=i%>">
                                                <input type="hidden" value="<%=aux2.elementAt(9)%>" name="resp">
                                                <input type="hidden" value="<%=aux2.elementAt(0)%>" name="serial">
                                                <a href="javascript:{}" onclick="document.getElementById('my_form<%=i%>').submit();"><img src="img/ok.png" width="20" height="22" border="0"></a>
                                            </form>
                                        </td>
                                        <td width="5%" width="15" align="center"><a href="/ServiOsiris.v2/ActInvent?ideq=<%=aux2.elementAt(0)%>"><img src="img/infoeq.png" width="20" height="22" border="0"></a></td>
                                    </tr>
                                    <%}%>
                                    <tr>
                                        <td colspan="11" bgcolor="#99CCFF">&nbsp;</td>
                                    <tr>
                                    </table>
                                </div>
 <%}else{%>
 <center><b>Usted no puede aprobar Equipos :(</b></center>
 <%}%>
                              </fieldset>
                          ...
                          <!--FOOTER-->
<footer class="footerContainer" style ="margin-top:0px;">
    <div class="container">        
        <div class="row">
            <style type="text/css">
