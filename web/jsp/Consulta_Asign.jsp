...
if(est == null && id_asig !=null){
   estado = bd.Solicitud_porAsignacion(rol,"0",usu,id_asig) ;
}
else if(est != null && id_asig == "0"){   
    estado = bd.Solicitud_porAsignacion(rol,est,usu,"0") ;
}
else if(est != null && id_asig != null){ 
    estado = bd.Solicitud_porAsignacion(rol,est,usu,id_asig) ;
}
%>
<html lang="es">
    <head>
                       ...
                       <form name="form1" method="post">
                                        <table width="100%" border="4">
                                            <tr>
                                                ...
                                                <td bgcolor="#FFFFFF" width="28%" height="33" > 
                                                    <div align="right"><font face="sans-serif" size="2" color="#000099"><b><font size="2">&oacute; Ingrese N&uacute;mero de Asignaci&oacute;n: &nbsp;&nbsp;</font></b></font></div>
                                                </td>
                                                <td>
              ...
              <tr> 
                <td bgcolor="#FFFFFF" colspan="2" height="33" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    <tr> 
                        <td align="center" bgcolor="#6699CC" colspan="10"><b><font face="sans-serif" size="3" color="#FFFFFF" >ASIGNACIONES: <%=estado.size()%></font></b></td>
                    </tr>
                    <tr align="center"> 
                      ...
                      <td width="18%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Inicio Proceso</b></font></td>
                      <td width="12%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Finalizaci&oacute;n</b></font></td>
                      <td width="37%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Observación Usuario Osiris </b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado Asginaci&oacute;n</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tipo Asignaci&oacute;n</b></font></td>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                     ...
                     <td width="5%" height="48" > 
                      ...
                      <td width="7%" height="48" > 
                        <div align="center"><font face="sans-serif" size="2" color="#000099"><a href="Detalle?idd=<%=res.elementAt(8)%>"><img src="img/detalle.png" width="20" height="22" border="0"></a></font></div>
                      </td>
                    </tr>
                    <%}%>
                    <tr bgcolor="#99CCFF"> 
