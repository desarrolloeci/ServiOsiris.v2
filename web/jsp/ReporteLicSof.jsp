<%-- 
    Document   : LicSoftware
    Created on : 14-sep-2017, 9:13:13
...
// if (usu_con != null )  {
  if (fecha_ini != null && fecha_fin != null )  {
    estado = bd.ConsultaReporteLicencias(fecha_ini,fecha_fin,nombreLic);
    }
...
<center>
                           ...
                           <table width="80%" border="2" class="table">
                                            <tr> 
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione rango fechas Licencia - inicio/fin (dd/mm/aaaa): </font></b></font>
                                                </td>
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                ...
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione Nombre Software: </font></b></font>
                                                </td>                                                 
                                                <td>
                                          ...
                                          <!----   <tr>
                                                <td colspan="6">
                                                    <button  onclick="window.location.href='/ServiOsiris.v2/Exportar?formato=excel&fechaini=<%=fecha_ini%>&fechafin=<%=fecha_fin%>&nombreLic=<%=nombreLic%>'">Exportar a Excel</button>  
                                                </td>
                                            </tr> ---->
                                        </table>
                           </center>
                ...
                <td bgcolor="#FFFFFF" colspan="2" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    ...
                    <tr> 
                      ...
                      <td width="5%" bgcolor="#99CCFF" height="15" align="center"><strong>Editar</strong></td>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                        ...
                        <td width="5%" width="15" align="center"><a href="/ServiOsiris.v2/EditarLicSoft?nombreSoft=<%=res.elementAt(1)%>&valorver=<%=res.elementAt(2)%>"><img src="img/Edit.png" width="20" height="22" border="0"></a></td>
  ...
  <%}else{%>
      ...
      <%}%>
                ...
                <!--FOOTER-->
<footer class="footerContainer" style="margin-top:425px;">
    <div class="container">        
        <div class="row">
            <style type="text/css">
