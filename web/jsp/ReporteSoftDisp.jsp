<%-- 
    Document   : ReporteSoftDisp
    Created on : 15-ene-2018, 8:14:46
...
String Area = "";
 ...
 Vector estado1 = new Vector();
      ...
      if(Area != null && !Area.equals("0")){  
       estado = bd.ReporteSoftDisp(Area);
      
      }else if(nombreLic != null && Area.equals("0")){
      estado = bd.ReporteSoftDisponible(nombreLic);
      } 
...
<center>
                ...
                <td bgcolor="#FFFFFF" colspan="2" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    ...
                    <tr> 
                      ...
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Version</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Area</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Condiciones de Uso</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>No. Licencias</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Licencias en uso</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Licencias Disponibles</b></font></td>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                        ...
                        <td width="5%" height="48" ><div align="center"><font face="sans-serif" size="2" color="#000099"><b><%= Integer.parseInt(res.elementAt(4).toString())- Integer.parseInt(res.elementAt(5).toString())%></b></font></div></td>
    ...
    <td background="img/portal_r2_c4.jpg" style="background-repeat:repeat-y" width="34">&nbsp;</td>
      ...
      <%}%>
                                    <!--FOOTER-->
<footer class="footerContainer" style="margin-top:450px;">
    <div class="container">        
        <div class="row">
            <style type="text/css">
