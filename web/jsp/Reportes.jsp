                ...
                <td bgcolor="#FFFFFF" width="100%"> 
                 <di>
                       <form name="formulario" method="post">
                           <table width="80%" border="4" class="table">
                                            <tr> 
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione rango fechas Solicitud - inicio/fin (dd/mm/aaaa): </font></b></font>
                                                </td>
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" size="2" color="#000099"><b><input type="date" name="fechaini" step="1" value=""></b></font>
                                                </td>   
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" color="#000099"><b><input type="date" name="fechafin" step="1"  value=""> </b></font>
                                                </td>
                                                <td bgcolor="#FFFFFF" width="10%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione Usuario OSIRIS: </font></b></font>
                                                </td>
                                                <td>
                                                            <select name="Usuario">
                                                ...
                                                <td bgcolor="#FFFFFF" width="10%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione Usuario Solicitante: </font></b></font>
                                                </td>
                                                <td width="20%">
                                                            
                                                    <select name="cliente" class="textocom">
                                                      <option value=""><font face="Times New Roman, Times, serif" size="2"> 
                                                      Seleccione el Usuario Solicitante</font></option>
                                                      <%if (usuari_es.size() > 0){
                                                      for (int ii = 0; ii < usuari_es.size(); ii++) {
                                                                                Vector inf = (Vector)usuari_es.elementAt(ii) ;%>
                                                      <option value="<%=inf.elementAt(2)%>"><font face="Times New Roman, Times, serif" size="2"><%=inf.elementAt(2)%> - <%=inf.elementAt(1)%></font></option>
                                                      <%}
                                                      }%>
                                                    </select>  
                                                ...
                                                <td bgcolor="#FFFFFF" width="20%" > 
                                                    <font face="sans-serif" color="#000099"><b><font size="2">Seleccione Estado de Solicitud: </font></b></font>
                                                </td>
                                                <td>
                  ...
                  <button onclick="window.location.href='/ServiOsiris.v2/Exportar?formato=excel&fechaini=<%=fecha_ini%>&fechafin=<%=fecha_fin%>&Usuario=<%=usu_con%>&Estado=<%=est%>&cliente=<%=cliente%>'">Exportar a Excel</button>
              ...
              <tr> 
                <td bgcolor="#FFFFFF" colspan="2" valign="top"> 
                  ...
                  <table width="100%" border="1" bordercolor="#FFFFFF" align="top">
                    <tr> 
                        <td align="center" bgcolor="#6699CC" colspan="22"><b><font size="3" color="#FFFFFF" >HISTORIAL DE ASIGNACIONES <%=solic%> -  # Registros Encontrados: <%=estado.size()%></font></b></td>
                    </tr>
                    <tr> 
                      ...
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado Solicitud</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Estado Asignaci&oacute;n</b></font></td>
                      ...
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Fecha Finalización Admin</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Usuario Solicitante</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Dependencia</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Bloque</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Extensión Solicitante</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Mail Usuario Crea Tarea</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tiempo en Iniciar Tarea</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tiempo en Proceso</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tiempo Solicitud</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Tipo Solicitud</b></font></td>
                      <td width="5%" bgcolor="#99CCFF" height="15"><font face="sans-serif" size="2" color="#000099"><b>Calificación Servicio</b></font></td>
                    ...
                    <tr bgcolor="#CCCCCC"> 
                       ...
                       <td width="5%" height="48" > 
                        ...
                        <td width="5%" height="48" > 
                          ...
                          <div align="center"><font face="sans-serif" size="2" color="#000099"><b><%=res.elementAt(18)%> <%=time%></b></font></div>
                        </td>
                        <td width="5%" height="48" > 
                            <%if(res.elementAt(19).equals("No disponible")){time = "";}else{time = "minutos";}%>
                          <div align="center"><font face="sans-serif" size="2" color="#000099"><b><%=res.elementAt(19)%> <%=time%></b></font></div>
                        </td>
                        <td width="5%" height="48" > 
                            <%if(res.elementAt(17).equals("No disponible")){time = "";}else{time = "minutos";}%>
                          <div align="center"><font face="sans-serif" size="2" color="#000099"><b><%=res.elementAt(17)%> <%=time%></b></font></div>
                        </td>
                        <td width="5%" height="48" > 
                          <div align="center"><font face="sans-serif" size="2" color="#000099"><b><%=res.elementAt(20)%></b></font></div>
                        </td>
                        <td width="5%" height="48" > 
                          <div align="center"><font face="sans-serif" size="2" color="#000099"><b><%=res.elementAt(24)%></b></font></div>
                        </td>
